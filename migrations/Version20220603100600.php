 ...
 */
final class Version20220603100600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ALTER content TYPE VARCHAR(2555)');
        $this->addSql('ALTER TABLE comment ALTER content TYPE VARCHAR(2555)');
